...
void Game::SetupResources(void){
	...
	resman_.CreateExhaustParticles("ExhaustParticles");
...
void Game::SetupScene(void){
	...
	game::SceneNode *particles = CreateInstance("ParticleInstance1", "ExhaustParticles", "FireMaterial", "Flame");
	particles->SetBlending(true);
	//particles->SetPosition(glm::vec3(0, -4, 0));
}
